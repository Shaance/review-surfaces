...
The seeded-regression eval harness (run inside `pnpm run test`) currently catches **16/16** seeded case(s) across 16 fact class(es) in the top 10 of the review queue:
