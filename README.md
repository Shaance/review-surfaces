...
The seeded-regression eval harness (run inside `pnpm run test`) currently catches **2/2** seeded case(s) across 2 fact class(es) in the top 10 of the review queue:
