...
The seeded-regression eval harness (run inside `pnpm run test`) currently catches **15/15** seeded case(s) across 13 fact class(es) in the top 10 of the review queue:
