...
Use `.agents/skills/composed-review-loop/SKILL.md` when a review should combine the packet, command transcripts, dogfood findings, PR comments, and a full-diff code review into one synthesized readiness decision.
