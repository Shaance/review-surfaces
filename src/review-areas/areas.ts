...
export const REVIEW_AREAS: ReviewArea[] = [
  ...
  area("SUB-BOOTSTRAP", "Bootstrap files", "BOOTSTRAP", ["AGENTS.md", "CLAUDE.md", ".agents/", "review-surfaces.config.yaml", "src/config/", "scripts/copy-env.sh", "scripts/SECRETS.md"], "Keep local source-of-truth and agent workflow files available.", "spec-first bootstrap", ["config", "bootstrap"]),
  ...
  area("SUB-DOGFOOD", "Dogfood loop", "DOGFOOD", ["src/dogfood/", ".review-surfaces/agent_handoff.md", ".review-surfaces/feedback/", "docs/dogfooding.md"], "Turn self-review findings into local product feedback and handoff.", "feedback loop", ["dogfood"]),
